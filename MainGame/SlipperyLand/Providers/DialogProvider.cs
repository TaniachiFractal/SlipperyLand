...
namespace SlipperyLand.Providers
{
    ...
    public class DialogProvider : IDialogProvider
    {
        ...
        private void ShowError(string message, string title)
            => Application.Current.Dispatcher.Invoke(() => new CustomMessageBox(message, title, MessageBoxImage.Error).ShowDialog());
        ...
        private void ShowInfo(string message, string title)
            => Application.Current.Dispatcher.Invoke(() => new CustomMessageBox(message, title, MessageBoxImage.Information, bigText: true, centeredText: true).ShowDialog());
